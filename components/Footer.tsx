        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><button onClick={() => onNavigate('HOME')} className="hover:text-canada-red transition-colors">{t.toolDelete}</button></li>
              <li><button onClick={() => onNavigate('HOME')} className="hover:text-canada-red transition-colors">{t.toolRotate}</button></li>
              <li><button onClick={() => onNavigate('HOME')} className="hover:text-canada-red transition-colors">{t.toolMakeFillable}</button></li>
              <li><button onClick={() => onNavigate('HOME')} className="hover:text-canada-red transition-colors">{t.toolHeic}</button></li>
              <li><button onClick={() => onNavigate('HOME')} className="hover:text-canada-red transition-colors">{t.toolEpubToPdf}</button></li>
            </ul>
          </div>
